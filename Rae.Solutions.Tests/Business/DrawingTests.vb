...
Public Class DrawingTests
   ...
   Sub Four_piping_drawing_names_are_generated_for_multiple_circuits
      ...
      IsTrue(names(0) = "SWP1A.dxf")
      IsTrue(names(1) = "SWP1B.dxf")
      IsTrue(names(2) = "SWP1C.dxf")
      IsTrue(names(3) = "SWP1D.dxf")
   End Sub

   <TestMethod()> _
   Sub Drawing_LoadDrawing()
      Dim drawingFilePath = "C:\Code\Rae\Solutions\Main\Rae.Solutions\Drawings\Drawings\Unit\MasterDrawings\10-A.dxf"
   ...
   '         Dim drawingFilePath = drawingFolderPath & drawingName & ".dxf"
