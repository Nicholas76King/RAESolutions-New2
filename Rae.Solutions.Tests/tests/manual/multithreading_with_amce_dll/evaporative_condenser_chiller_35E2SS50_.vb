...
public class evaporative_condenser_chiller_35E2SS50_ : inherits test_chiller_base
   ...
   sub balance_point_is_correct
      ...
      assert( round(point.unit_kw, 1) = 39.9,            "unit kw is wrong")
...
public class test_chiller_base : inherits test_base
   ...
   protected function get_evaporator_context(chiller as chiller, spec as spec) as chillers.evaporator_iplv_context
      dim evaporator_repo = new Evaporator_repository()
      dim evaporator = evaporator_repo.get_evaporator_by_part_number(chiller.evaporator_model)

      dim context = new chillers.evaporator_iplv_context()
      context.evaporator_part_number = chiller.evaporator_model
      context.service = new Evaporator_service_factory().create()
      ...
      context.spec_used_for_balance = evaporator_spec
