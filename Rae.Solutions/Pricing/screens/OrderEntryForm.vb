...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.selectedOpGrid.Size = New System.Drawing.Size(639, 150)
...
#Region " Event handling"
    ...
    Private Sub form_Load() Handles MyBase.Load
        ...
        ' blargg
        ' hide nmb and nmc 
        EquipmentSelector1.cbo_series.Items.Remove("NMB")
        EquipmentSelector1.cbo_series.Items.Remove("NMC")
    ...
    Handles availableOpTable.ColumnChanged
        ...
        If e.Column.ColumnName = OCol.Selected Then  ' hits on auto select
            ...
            If CBool(e.Row(OCol.Selected)) Then
                ...
                If e.Row(OCol.Code).ToString() = "MA01" Or e.Row(OCol.Code).ToString() = "MA02" Or e.Row(OCol.Code).ToString() = "MA17" Or _
                ...
                If e.Row(OCol.Code).ToString() = "MV06" Then
                    For Each row As DataRow In availableOpTable.Rows
                        If CBool(row(OCol.Selected)) Then
                            If row(OCol.Code).ToString() = "MA01" Or row(OCol.Code).ToString() = "MA02" Or row(OCol.Code).ToString() = "MA17" Or _
...
#End Region
    ...
    Handles tabEquipment.SelectedIndexChanged
        ...
        If cboUnitVoltage.Text.Trim > " " Then
            If Me.Equipment.series = "DD" Or Me.Equipment.series = "DM" Or Me.Equipment.series = "DS" Or Me.Equipment.series Like "2*" Or Me.Equipment.series Like "3*" Or Me.Equipment.series Like "4*" Or Me.Equipment.series = "LUI" Or Me.Equipment.series = "LUO" Or Me.Equipment.series = "RS" Or Me.Equipment.series Like "N*" Then
    ...
    Public Function evapTempBlur() As Boolean
        FaceVelocityInRange()
    End Function
    ...
    Public Function FaceVelocityInRange() As Boolean
        ...
        If Me.EquipmentSelector1.Model.EndsWith("A") Then

            If faceVelocity > 625 Then
        ...
        Else
            ...
            If evaporatorTempValue >= 25 Then
                If faceVelocity > 625 Then
    ...
    Public Function CheckObligatoryOptionsAndSpecs(ByRef returnTab As Integer) As Boolean
        ...
        If (selectedOptions.Contains("CK01") AndAlso selectedOptions.Contains("MF01") AndAlso Not selectedOptions.Contains("CK02")) _
            ...
            MsgBox("Option code CK01 is required when both a CHILLER KIT and FLOOD CONTROL are selected.  This option will be automatically selected")
...
#Region " Grab and display methods"
    ...
    Sub calculateAndDisplayPrices()
        ...
        If AppInfo.Division = CRI Then
            ...
            Dim sql = "select MultiplierType from Equipment where EquipmentID = '" & equipmentID & "' ORDER BY ProjectRevision DESC"
            ...
            If multiplierType = "" And Not AppInfo.User.is_in(century_sales) Then
                If AppInfo.User.works_at_resco Then
                    multiplierType = "Resco"
                Else
        ...
        If Me.SpecialOptionsControl1.opGrid.RowCount > 0 Then
            ...
            For Each op As SpecialOption In Me.SpecialOptionsControl1.SpecialOptions
                ...
                Me.selectedOpsDs.SelectedOptions.AddSelectedOptionsRow(0, "", _
                   op.ToString, op.AuthorizedBy, description, op.Price.value, op.Quantity.value.ToString, _
                   False, 0, False, "")
            Next
        End If
    End Sub
